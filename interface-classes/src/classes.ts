...
class SalesDepartment extends Department3{
    ...
    private constructor(id: string, public name: string[]) {
        super(id, ['Sales']);
    }
    ...
    static getInstance() {
        if (this.instance) {
            ...
            this.instance = new SalesDepartment('d6', []);
            return this.instance;
        }
    }
...
const sales = SalesDepartment.getInstance();
const sales2 = SalesDepartment.getInstance();
console.log(sales, sales2);
